...
// Lemonschain Token © Lemonschain.com
...
contract Lemonschain is ERC20, ERC20Burnable, Pausable, TwoPhaseOwnable {
    ...
    constructor() ERC20("Lemonschain", "LCT") {
        _mint(msg.sender, 127000000 * (10 ** uint256(decimals())));  
    }
